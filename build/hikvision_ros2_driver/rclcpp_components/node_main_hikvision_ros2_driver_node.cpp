...
#define NODE_MAIN_LOGGER_NAME "hikvision_ros2_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhikvision_ros2_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<hikvision_ros2_driver::HikvisionDriver>";
